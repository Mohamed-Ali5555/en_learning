         ...
         <div class="row">
             <div class="col-md-12 col-sm-12 col-xs-12 content-inner">
                 @foreach ($contactus as $contact)
                     <div class="logo">
                         <a href=""><img src="{{ asset("storage/$contact->logo") }}"alt=""
                                 style="    height: 68px;
                            width: 240px;"></a>
                     </div>
                 @endforeach
                 <div class="main_menu">
                     ...
                     <ul class="menu">
                         <li style="margin-bottom: 30px; border-bottom: none;"><a id="close"><i
                         ...
                         <li>
                             <a href="{{ route('boutusFront') }}">aboutus<span id="sub_6"
