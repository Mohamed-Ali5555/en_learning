...
<head>
    ...
    <!-- css -->
    <link href="{{ URL::asset('backend/assets/Admin/css/ltr.css') }}" rel="stylesheet">
...
login-->
    ...
    <section class="height-100vh d-flex align-items-center page-section-ptb login"
             style="background-image: url(backend/assets/Admin/images/login-bg.jpg);">
        <div class="container">
            <div class="row justify-content-center no-gutters vertical-align">
                <div class="col-lg-4 col-md-6 login-fancy-bg bg"
                     style="background-image: url(backend/assets/Admin/images/login-inner-bg.jpg);">
